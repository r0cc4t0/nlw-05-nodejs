...
function call(id) {
  ...
  const rendered = Mustache.render(template, { email: connection.user.email, id: connection.user_id });
...
function sendMessage(id) {
  ...
  const params = { text: text.value, user_id: id };
  ...
  createDiv.innerHTML += `<span class="admin_date">
    ${dayjs().format('DD/MM/YYYY HH:mm:ss')}</span>`;
